...
<div class="container">
    <div class="title"> Add New Player </div>
    <form method="POST" action="{{route("player.store")}}">
        ...
        <div class="input-group">
            ...
            <div class="content-center">
                    ...
                    <div class="absolute">
                        <input type="text" name="name" placeholder="Player Name" class="input" >
        ...
        <div class="input-group">
            ...
            <div class="content-center">
                    ...
                    <div class="absolute">
                        <input type="text" name="age" placeholder="Player Age" class="input" >
        ...
        <div class="input-group">
            ...
            <div class="content-center">
                    ...
                    <div class="absolute">
                        <input type="text" name="position" placeholder="Player Age" class="input" >
